        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Tambah Jurusan / Prodi</h4>
                            <button type="button" class="btn btn-primary tambah-baris-jurusan">
                                Tambah Baris
                            </button>
                            <form action="<?= base_url('jurusan/f_tambah'); ?>" method="POST">
                                <div class="table-responsive mt-3">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody id="tbody-data-jurusan">
                                            <tr>
                                                <td><input type="text" name="nama_jurusan[]" class="form-control" required style="width: 100%; border: none; font-size: 14px;" required autofocus></td>
...
<script>
    $(document).ready(function() {
        $('.tambah-baris-jurusan').click(function() {
           ...
           `;
            $('#tbody-data-jurusan').append(baru);
        });

        $('#tbody-data-jurusan').on('click', 'tr td button', function() {

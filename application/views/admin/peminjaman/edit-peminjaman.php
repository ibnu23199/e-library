...
<div class="container-fluid page-body-wrapper">
    <div class="main-panel">
        <div class="content-wrapper">
            <form action="<?= base_url('peminjaman/f_edit'); ?>" method="POST">
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Ubah Peminjam</h4>
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select name="siswa" id="siswa" class="select2 form-control" required>
                                                ...
                                                <?php foreach ($siswa as $s) : ?>
                                                    <?php if ($s->no_induk == $peminjaman->siswa) : ?>
                                                        <option value="<?= $s->no_induk; ?>" selected><?= $s->nama_siswa; ?></option>
                                                    <?php else : ?>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="lama_peminjaman" value="<?= $peminjaman->lama_peminjaman; ?>" class="form-control" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="denda" id="denda" class="select2 form-control" required>
                                                ...
                                                <?php foreach ($denda as $d) : ?>
                                                    <?php if ($d->id_denda == $peminjaman->jenis_denda_harian) : ?>
                                                        <option value="<?= $d->id_denda; ?>" selected><?= $d->nama_denda; ?> ( <?= $d->jumlah_denda; ?> / Hari )</option>
                                                    <?php else : ?>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody id="list-buku-dipinjam">
                                            <?php foreach ($detail_peminjaman as $dp) : ?>
                                                <tr>
                                                    <td>
                                                        <input type="text" name="judul_buku[]" value="<?= $dp->judul_buku; ?>" class="form-control" readonly="" style="background: transparent;">
                                                        <input type="hidden" name="kode_buku[]" value="<?= $dp->kode_buku; ?>" class="form-control" readonly="">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="jumlah_buku[]" value="<?= $dp->jumlah; ?>" class="form-control" readonly="" style="background: transparent;">
                                                    </td>
                                                    <td>

        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Tambah Denda terlambat</h4>
                            <button type="button" class="btn btn-primary tambah-baris-denda-harian">
                                Tambah Baris
                            </button>
                            <form action="<?= base_url('denda/f_tambah/') .  encrypt_url(1); ?>" method="POST">
                                <div class="table-responsive mt-3">
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th>Nama</th>
                                                <th class="text-center">Nominal / Hari</th>
                                                <th>Opsi</th>
                                            </tr>
                                        </thead>
                                        <tbody id="tbody-data-denda-harian">
                                            <tr>

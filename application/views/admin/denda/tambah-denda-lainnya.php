        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Tambah Denda Lainnya</h4>
                            <button type="button" class="btn btn-primary tambah-baris-denda-lainnya">
                                Tambah Baris
                            </button>
                            <form action="<?= base_url('denda/f_tambah/') .  encrypt_url(2); ?>" method="POST">
                                <div class="table-responsive mt-3">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody id="tbody-data-denda-lainnya">
                                            <tr>
